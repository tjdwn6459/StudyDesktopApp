...
namespace StudyHistoryApp
{
    public partial class FrmMain : Form
    {
        ...
        private void TrvList_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            if (e.Node.Name == "ANN1")
            {
                PcbPhoto.Image = Bitmap.FromFile(@"D:\GitRepository\StudyDesktopApp\WindowformApp\ExcerciseWinApp\StudyHistoryApp\images\Anne.jpg");
                TxtDescription.Text = "앤 여왕은 1702년 3월 8일 잉글랜드와 스코틀랜드" +
                    ...
                    "laborum nemo veniam optio quisquam earum aperiam esse soluta eligendi" +
                    " unde dolore impedit.";
            }
